...
function filterAndMutatePanels(panels) {
    return panels.map((panel) => (Object.assign(Object.assign({}, panel), { uid: `${panel.id}` })));
}
/**
 *
 * @param sourcePanels
...
function getPanels(environment) {
    return __awaiter(this, void 0, void 0, function* () {
        const privatePanels = yield (0, CRUD_1.default)({
        ...
        return privatePanels === null || privatePanels === void 0 ? void 0 : privatePanels.data;
    });
}
...
//# sourceMappingURL=panels-migration.js.map