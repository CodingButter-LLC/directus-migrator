        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    Logger_js_1.default.info("Created: ".concat(createdPermissions_1.length, ", Updated: ").concat(updatedPermissions.length, ", Deleted: ").concat(deletedPermissions.length));
                ...
                case 5:
                    _d.sent();
                    Logger_js_1.default.info("Updated ".concat(updatedPermissions.length, " Permissions"));
