...
function logErrors(errors, url) {
    Logger_1.default.error("Error in ".concat(url));
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    Logger_1.default.debug(JSON.stringify({ url: url, method: method, data: data }));
...
function fileCRUD(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            directoryPath = (0, path_1.resolve)(__dirname, filePath.split("/").slice(0, -1).join("/"));
            file = (0, path_1.resolve)(__dirname, filePath);
            ...
            jsonData = JSON.parse((0, fs_1.readFileSync)(file, "utf8"));
            ...
            (0, fs_1.writeFileSync)(file, JSON.stringify(jsonData));
            return [2 /*return*/, jsonData];
        });
    });
}
