...
var printf = winston_1.format.printf, combine = winston_1.format.combine, timestamp = winston_1.format.timestamp, label = winston_1.format.label, colorize = winston_1.format.colorize;
var deviceLabel = process.env.DEVICE_LABEL || process.env.NODE_ENV;
try {
    var ghEmail = (_b = (_a = (0, child_process_1.execSync)("git config --global user.email")) === null || _a === void 0 ? void 0 : _a.toString()) === null || _b === void 0 ? void 0 : _b.trim();
    var ghUser = (_d = (_c = (0, child_process_1.execSync)("git config --global user.name")) === null || _c === void 0 ? void 0 : _c.toString()) === null || _d === void 0 ? void 0 : _d.trim();
